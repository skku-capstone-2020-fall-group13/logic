...
#100~900사이의 값은 중앙 그 외는 외곽으로 판정
  ...
  obj['standard'].append({"name" : "편의성 점수", "Desc" : "대형건물 수", "Score" : conv_ret})
  obj['standard'].append({"name" : "공장, 도로 점수", "Des" : "매연, 소음 등 마이너스 요소", "Score" : env_minus_ret})
  obj['standard'].append({"name" : "녹지, 강 점수", "Desc" : "환경 요소", "Score" : env_plus_ret})
  obj['standard'].append({"name" : "주택/아파트 점수", "Description" : "개인 선호도", "Score" : score_house})
  obj['standard'].append({"name" : "논밭 점수", "Desc" : "개인 지표", "Score" : field})
  obj['score'].append({"쾌적도" : env_plus_ret+env_minus_ret+conv_ret})
